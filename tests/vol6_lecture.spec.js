...
const URL = '/lectures/vol6_lecture.html';

test.describe('Vol VI — Standard Library player', () => {
  test('loads, renders the first slide, and throws no console/page errors', async ({ page }) => {
    ...
    await page.goto(URL);
    await expect(page.locator('#st')).toHaveText('stdio.h -- formatted I/O and file streams');
