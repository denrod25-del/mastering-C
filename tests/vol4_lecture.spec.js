...
const URL = '/lectures/vol4_lecture.html';

test.describe('Vol IV — Preprocessor, Build & Linkage player', () => {
  test('loads, renders the first slide, and throws no console/page errors', async ({ page }) => {
    ...
    await page.goto(URL);
    await expect(page.locator('#st')).toHaveText('The four phases of compilation');
